...
FrameModel = FlowCatFrameGenModel(in_h, in_w, f_l, g_l, torch.nn.functional.mse_loss, learning_rates).to(DEVICE)
...
train_data, val_data, test_data = torch.clone(data), torch.clone(data), torch.clone(data)

print("COMPUTING OPTICAL FLOW")

train_flow_data = gen_flow_data(train_data, TRAIN_FRAME_DIFF)
val_flow_data   = gen_flow_data(val_data, TEST_FRAME_DIFF)
test_flow_data  = gen_flow_data(test_data, TEST_FRAME_DIFF)

print("FINISHED OPTICAL FLOW COMPUTATION AND STORING")

in_train_batch = gen_batch_sample(train_data, train_flow_data, VAL_SIZE, TRAIN_FRAME_DIFF)
val_batch  = gen_batch_sample(val_data, val_flow_data, VAL_SIZE, TEST_FRAME_DIFF)
test_batch = gen_batch_sample(test_data, test_flow_data, VAL_SIZE, TEST_FRAME_DIFF)
...
for itr in range(TRAIN_ITERATIONS):
    train_batch = gen_batch_sample(train_data, train_flow_data, BATCH_SIZE, TRAIN_FRAME_DIFF)
