...
train_flow_data = gen_flow_data(train_data, FRAME_DIFF)
val_flow_data   = gen_flow_data(val_data, FRAME_DIFF)
test_flow_data  = gen_flow_data(test_data, FRAME_DIFF)

print("FINISHED OPTICAL FLOW COMPUTATION AND STORING")

in_train_batch = gen_batch_sample(train_data, train_flow_data, BATCH_SIZE * 2, FRAME_DIFF)
val_batch  = gen_batch_pure(val_data, val_flow_data, FRAME_DIFF)
test_batch = gen_batch_pure(test_data, test_flow_data, FRAME_DIFF)
...
for itr in range(TRAIN_ITERATIONS):
    train_batch = gen_batch_sample(train_data, train_flow_data, BATCH_SIZE, FRAME_DIFF)
